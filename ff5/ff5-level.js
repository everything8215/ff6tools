...
class FF5LevelProgression extends ROMEditor {
    ...
    resetControls() {
        ...
        for (const [s, stat] of FF5LevelProgression.stats.entries()) {
    ...
    loadCharacter() {
        ...
        propertyList.select(this.expProgression.item(0));
    ...
    updateStats() {
        ...
        // for (const stat of FF5LevelProgression.stats) {
        //     let value = 0;
        //     if (stat.key === 'exp') {
        //         value = 0;
        //     } else if (stat.key === 'hp') {
        ...
        while (currentStats.level < 99) {
            ...
            for (const stat of FF5LevelProgression.stats) {
                ...
                if (stat.key === 'exp') {
                    ...
                    // const modifier = this.characterProperties.stamina.value;
                    // value = Math.floor(value * (modifier + 32) / 32);
                } else if (stat.key === 'mp') {
                    value = this.mpProgression.item(i).mp.value;
                    // const modifier = this.characterProperties.magicPower.value;
                    // value = Math.floor(value * (modifier + 32) / 32);
                }
